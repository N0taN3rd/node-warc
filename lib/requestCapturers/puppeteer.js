 ...
 */
class PuppeteerRequestCapturer extends RequestHandler {
  /**
   * @param {Object} [navMan]
   */
  constructor (navMan) {
  ...
  /**
   * @external {CDPSession} https://github.com/GoogleChrome/puppeteer/blob/v1.3.0/docs/api.md#class-cdpsession
