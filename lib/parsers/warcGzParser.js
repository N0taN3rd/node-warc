  ...
  start () {
    if (!this._parsing) {
      ...
      this._readStream
        ...
        .pipe(bsplit(CRLF))
        .on('data', line => {
          // console.log(warcFieldIdentifiers.begin)
          // console.log(line.toString())
          // console.log(warcFieldIdentifiers.begin.toString())
          if (line.indexOf(warcFieldIdentifiers.begin) !== -1) {
            console.log('begin')
            console.log(line)
