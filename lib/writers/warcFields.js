 ...
 * @returns {string}
 */
const warcHeader = ({ now, fileName, rid, len }) => `WARC/1.1\r
...
conformsTo: http://iipc.github.io/warc-specifications/specifications/warc-format/warc-1.1/\r
...
WARC-Target-URI: ${targetURI}\r
WARC-Date: ${now}\r
${concurrentTo ? `WARC-Concurrent-To: <urn:uuid:${concurrentTo}>\r` : ''}
WARC-Record-ID: <urn:uuid:${rid}>\r
${wid ? `\nWARC-Warcinfo-ID: <urn:uuid:${wid}>\r` : ''}
 ...
 * @returns {string}
 */
const warcResponseHeader = ({ targetURI, now, rid, len, wid }) => `WARC/1.1\r
