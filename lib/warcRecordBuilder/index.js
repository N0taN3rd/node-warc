...
class WARCRecorderBuilder {
  ...
  initInfo (bgn, line) {
    ...
    if (!builder) {
      builder = newBuilder(builderKeyInfo)
  ...
  initMdata (bgn, line) {
    ...
    if (!builder) {
      builder = newBuilder(builderKeyMdata)
  ...
  initReq (bgn, line) {
    ...
    if (!builder) {
      builder = newBuilder(builderKeyReq)
  ...
  initRes (bgn, line) {
    ...
    if (!builder) {
      builder = newBuilder(builderKeyRes)
  ...
  initRevist (bgn, line) {
    ...
    if (!builder) {
      builder = newBuilder(builderKeyRev)
  ...
  initUnknown (bgn, line) {
    ...
    if (!builder) {
      builder = newBuilder(builderKeyUnknown)
  ...
  initResource (bgn, line) {
    ...
    if (!builder) {
      builder = newBuilder(builderKeyResource)
  ...
  addLineTo (key, ctrlfCount, line) {
    ...
    builder.addLine(ctrlfCount, line)
  }
